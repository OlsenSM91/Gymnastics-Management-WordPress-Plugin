...
function wsm_families_page() {
    ...
    if (isset($_GET['delete_family'])) {
        ...
        echo '<meta http-equiv="refresh" content="0; url=?page=wsm-families">';
    }
        ...
        if (isset($_POST['query'])) {
            ...
            foreach ($family_posts as $family) {
                $results[] = [
                    ...
                    'url' => admin_url('admin.php?page=wsm-families&family_id=' . $family->ID),
                    'family_id' => $family->ID,
                    'athlete_id' => null,
                ];
            }
                    ...
                    foreach ($athletes as $athlete) {
                        if (stripos($athlete['first_name'], $query) !== false || stripos($athlete['last_name'], $query) !== false) {
                            $results[] = [
                                ...
                                'url' => admin_url('admin.php?page=wsm-families&athlete_id=' . $athlete['id'] . '&family_id=' . $family->ID),
                                'family_id' => $family->ID,
