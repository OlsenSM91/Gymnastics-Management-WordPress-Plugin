...
function wsm_sessions_page() {
    ...
    if ($selected_level) {
        ...
        echo '<a href="' . admin_url('admin.php?page=wsm-sessions') . '" class="gm-dashboard-tile">Back to Levels</a>';
        ...
        foreach ($levels as $level) {
            echo '<a href="' . admin_url('admin.php?page=wsm-sessions&level_id=' . $level->term_id) . '" class="gm-dashboard-tile">' . esc_html($level->name) . '</a>';
        }
        echo '</div>';
    }
...
function wsm_add_session() {
    ...
    wp_redirect(admin_url('admin.php?page=wsm-sessions&level_id=' . intval($_POST['level_id'])));
    exit;
}
